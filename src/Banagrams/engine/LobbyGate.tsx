...
export function LobbyGate({ onEnter, onShowInstructions }: Props) {
  ...
  // Options now live in the waiting room; keep lobby creation lightweight here.
      ...
      <div style={{ width: "min(820px, 96vw)", background: "rgba(255,255,255,0.92)", padding: 24, borderRadius: 16, boxShadow: "0 12px 32px rgba(0,0,0,0.08)" }}>
        <div style={{ display: "flex", gap: 12, alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
          <div>
            ...
            <div style={{ color: "#6b7280", fontSize: 14 }}>Pick a nickname, create a lobby, tweak settings in the waiting room.</div>
          </div>
        ...
        <div style={{ display: "grid", gap: 12, marginBottom: 16 }}>
          ...
          <div>
            <label htmlFor="lobby-name" style={{ display: "block", fontWeight: 600, marginBottom: 6 }}>
              Lobby name (optional)
            </label>
            <input
              id="lobby-name"
