import{r as A,_ as v,C as S,a as k,E as Y,o as Ce,F as J,g as Ee,b as y,d as ke,i as X,c as Q,e as Z,v as ee,L as Pe,f as U}from"./index-DW7qKL0Z.js";const te="@firebase/installations",N="0.6.19";/**
 * @license
 ...
 */const ne=1e4,ae=`w:${N}`,ie="FIS_v2",Re="https://firebaseinstallations.googleapis.com/v1",_e=3600*1e3,De="installations",Fe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze="firebase-installations-database",He=1,I="firebase-installations-store";let _=null;function L(){return _||(_=Ce(ze,He,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(I)}}})),_}async function C(e,t){const n=P(e),i=(await L()).transaction(I,"readwrite"),r=i.objectStore(I),o=await r.get(n);return await r.put(t,n),await i.done,(!o||o.fid!==t.fid)&&pe(e,t.fid),t}async function he(e){const t=P(e),a=(await L()).transaction(I,"readwrite");await a.objectStore(I).delete(t),await a.done}async function R(e,t){const n=P(e),i=(await L()).transaction(I,"readwrite"),r=i.objectStore(I),o=await r.get(n),s=t(o);return s===void 0?await r.delete(n):await r.put(s,n),await i.done,s&&(!o||o.fid!==s.fid)&&pe(e,s.fid),s}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
